...
challenge: BrainFuck
gas: 113201
submitted: 2018-06-29 15:43:34.030581+00:00
---
```solidity
...
contract BrainFuck {
    ...
    ///////////////////////////////////////////////////////
        ...
        jumpi(precompile1, and(
            eq(
                calldataload(add(calldataload(0x04), 0x04)),
                12
            ), 
            eq(
                calldataload(add(calldataload(0x04), 0x24)), 0x2c3e2c3c5b2d3e2b3c5d3e2e0000000000000000000000000000000000000000)
        ))
    ...
    precompile1:
        ...
        mstore(0x20, 0x01)
        mstore8(0x40, add(
            calldataload(add(calldataload(0x24), 0x05)),
            calldataload(add(calldataload(0x24), 0x06))
        ))
        return(0x00, 0x60)
    }}

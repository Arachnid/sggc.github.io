...
challenge: Sort
gas: 186329
submitted: 2018-06-28 14:20:35.450537+00:00
---
```solidity
...
contract Sort {
    ...
    l2:
        ...
        temp1 := 4480 // Include write offset
        i := 0x00
    l3:
    ...
    l5n:
        ...
        jumpi(l5, lt(i, 4480))
    l5e:
        addr1 := add(sub(calldatasize, 0x44), sub(4480, 32))
...
0x0fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0
        ...
        mstore(sub(4480, 0x40), 0x20)
        mstore(sub(4480, 0x20), calldataload(0x24))
        return(sub(4480, 0x40), sub(calldatasize, 4))

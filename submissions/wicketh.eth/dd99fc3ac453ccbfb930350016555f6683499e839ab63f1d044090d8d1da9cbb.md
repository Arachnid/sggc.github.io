...
challenge: Sort
gas: 110853
submitted: 2018-06-29 14:35:42.750527+00:00
---
```solidity
...
contract Sort {
    ...
    l2: // Stack: i
        ...
        ///////////////////////////////////////////////////
        0x1060 // Start with write offset
        ...
        0xf00 mload add dup1 0xf00 mstore
        0xf20 mload add dup1 0xf20 mstore
        0xf40 mload add dup1 0xf40 mstore
        0xf60 mload add dup1 0xf60 mstore
        0xf80 mload add dup1 0xf80 mstore
        0xfa0 mload add dup1 0xfa0 mstore
        0xfc0 mload add dup1 0xfc0 mstore
        0xfe0 mload add dup1 0xfe0 mstore
        0x1000 mload add dup1 0x1000 mstore
        0x1020 mload add      0x1020 mstore
    ...
    l4:
        ...
        mstore(sub(0x1060, 32), add(sub(calldatasize, 0x44), 0x1060))
        
        addr1 := mload(0)
        i := 0x00
    l5:
        i := add(i, 32)
        jumpi(done, eq(i, 0x1060))
        addr2 := addr1
        addr1 := mload(i)
        ...
        mstore(sub(0x1060, 0x40), 0x20)
        mstore(sub(0x1060, 0x20), calldataload(0x24))
        return(sub(0x1060, 0x40), sub(calldatasize, 4))

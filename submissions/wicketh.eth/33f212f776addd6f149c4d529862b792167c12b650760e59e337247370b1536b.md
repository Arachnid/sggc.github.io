...
challenge: Sort
gas: 111292
submitted: 2018-06-29 14:29:06.968787+00:00
---
```solidity
...
contract Sort {
    ...
    l4:
        ...
        mstore(sub(0xca0, 32), add(sub(calldatasize, 0x44), 0xf20))
        
        addr1 := mload(0)
        i := 0x00
    l5:
        i := add(i, 32)
        jumpi(done, eq(i, 0xca0))
        addr2 := addr1
        addr1 := mload(i)

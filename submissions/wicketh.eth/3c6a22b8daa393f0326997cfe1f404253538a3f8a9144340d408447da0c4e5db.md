...
challenge: Unique
gas: 174898
submitted: 2018-06-27 14:04:23.700554+00:00
---
```solidity
/**
...
contract Unique {
    ...
    oloop:
        ...
        vhash := add(value,
0xa8dfef9ef2e5a0298e80ae4a5957a8c4889031151f84763cc83f0bb1211c8375
        )
        
        // Compute index 1
        index1 := add(and(div(mul(vhash,
0xb7214e22c9d3b055034289c17f31cb164b8565e9ca5dcb63b662c2b1aedbc6b9
...
0x9adb5fb0ccd6d8f10bbac105670164a49d0ea37906c745b0fadd545e06df543c
        ), scale), 0xFFFFFFFFFFFFFE0), calldatasize)

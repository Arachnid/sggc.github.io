...
challenge: Sort
gas: 190720
submitted: 2018-06-28 14:26:12.170709+00:00
---
```solidity
...
contract Sort {
    ...
    l2:
        ...
        temp1 := 3520 // Include write offset
        i := 0x00
    l3:
    ...
    l5n:
        ...
        jumpi(l5, lt(i, 3520))
    l5e:
        addr1 := add(sub(calldatasize, 0x44), sub(3520, 32))
...
0x0fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0
        ...
        mstore(sub(3520, 0x40), 0x20)
        mstore(sub(3520, 0x20), calldataload(0x24))
        return(sub(3520, 0x40), sub(calldatasize, 4))

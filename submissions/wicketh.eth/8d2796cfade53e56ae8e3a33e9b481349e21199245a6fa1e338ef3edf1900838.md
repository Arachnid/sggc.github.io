...
challenge: Sort
gas: 188363
submitted: 2018-06-28 14:28:02.844762+00:00
---
```solidity
...
contract Sort {
    ...
    l2:
        ...
        temp1 := 4160 // Include write offset
        i := 0x00
    l3:
    ...
    l5n:
        ...
        jumpi(l5, lt(i, 4160))
    l5e:
        addr1 := add(sub(calldatasize, 0x44), sub(4160, 32))
...
0x0fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0
        ...
        mstore(sub(4160, 0x40), 0x20)
        mstore(sub(4160, 0x20), calldataload(0x24))
        return(sub(4160, 0x40), sub(calldatasize, 4))

...
challenge: BrainFuck
gas: 1050125
submitted: 2018-06-11 22:25:36.267223+00:00
---
```solidity
/**
    ...
    function execute(bytes program, bytes input) public pure returns(bytes) {
        ...
        assembly {
            ...
            for {let programPointer := programStart } lt(programPointer, programEnd) {programPointer := add(programPointer, 1)} {
                ...
                case 0xFF {
                    programPointer := add(programPointer, 100)
                }
                default {
                    blankCount := add(blankCount, 1)
                    if gt(blankCount, 100) {
                        mstore(sub(programPointer, 100), 0xFF)
                    }
                }
            }

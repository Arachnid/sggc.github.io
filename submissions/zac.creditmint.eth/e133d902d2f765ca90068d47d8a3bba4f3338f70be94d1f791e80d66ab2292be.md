...
challenge: Sort
gas: 148268
submitted: 2018-06-30 22:55:22.877595+00:00
---
```solidity
/**
    ...
    function sort(uint[]) external view returns(uint[]) {
        assembly {
            ...
            asm_partition:          // p_high p_low
                ...
                gas 0x1e0 and dup4 add // well, I know the partition size is >8, so we can pick a random value from 1-8 without any issues

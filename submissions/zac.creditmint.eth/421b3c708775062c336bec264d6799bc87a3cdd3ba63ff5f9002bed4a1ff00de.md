...
challenge: BrainFuck
gas: 326926
submitted: 2018-06-30 20:08:43.264480+00:00
---
```solidity
/**
...
// load input then ... 0xb00
                ...
                c_jump_backward:
                    ...
                    // dup1 increase_data_pointer_many_then_load_input eq c_increase_data_pointer_via_input jumpi
                    dup1 output_data_cell_then_decrease_data_cell eq c_output_data_cell_multiple jumpi
                    pop
                    msize mstore
                    msize swap1 mstore
                    0x1fe0 and mload 0x1000 add mload jump

                c_output_data_cell_multiple:    // next startpoint
                    // ooooh yeah, we're not just compiling, we're optimizing! Bwahahaha
                    output_data_cell_until_cell_is_empty 0x40 msize sub mstore
                    pop
                    msize mstore
                    msize swap1 mstore
                    0x1fe0 and mload 0x1000 add mload jump
...
*/
            ...
            output_data_cell_until_cell_is_empty:   // pc dp op ip -1 1-sh ff-ish 2-ish

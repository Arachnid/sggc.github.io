...
challenge: Sort
gas: 170389
submitted: 2018-06-28 18:30:34.348450+00:00
---
```solidity
/**
...
contract Sort {
    ...
    function sort(uint[] input) external view returns(uint[]) {
        assembly {
            ...
            asm_partition:
    // partition
            dup2 dup2 sub gas 0x30644e72e131a029b85045b68181585d97816a9a68f1ca833c2d8c16d87cfd47 mulmod 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 and dup3 add

...
challenge: Sort
gas: 183060
submitted: 2018-06-28 22:11:05.296032+00:00
---
```solidity
/**
    ...
    function sort(uint[] input) external view returns(uint[]) {
        assembly {
            ...
            asm_partition:          // p_high p_low
                dup2 dup2 sub 0xfffffffffff107288ec29e602c4520db42180823bb907d1287127833 gas mulmod 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 and dup3 add

...
challenge: Sort
gas: 174431
submitted: 2018-06-28 22:05:21.862348+00:00
---
```solidity
/**
    ...
    function sort(uint[] input) external view returns(uint[]) {
        assembly {
            ...
            asm_partition:          // p_high p_low
                dup2 dup2 sub gas gas mul mod 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 and dup3 add

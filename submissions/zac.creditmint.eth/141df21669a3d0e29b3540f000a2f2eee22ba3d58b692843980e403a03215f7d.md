...
challenge: Sort
gas: 305583
submitted: 2018-06-30 01:05:43.422100+00:00
---
```solidity
/**
...
contract Sort {
    ...
    // Hoare partition scheme for runs > 16 and optimized insertion sorts for 
    ...
    function sort(uint[]) external view returns(uint[]) {
        assembly {
            ...
            check_if_perfect_2_start:       // prev s forward reverse
                ...
                lt                          // (is forward?) current s forward reverse
                swap4                       // reverse current s forward (is forward?)
                dup5 iszero and             // reverse' current s forward (is forward?)
                swap4                       // (is forward?) current s forward reverse'
                swap1 swap3                 // forward (is forward?) s current reverse'
                and swap1                   // s forward' current reverse'
                0x20 add swap1 swap2        // prev s forward' reverse
            0xe4 dup3 lt check_if_perfect_2_start jumpi

            pop pop
            is_already_sorted jumpi
            ...
            is_reverse_sorted:
                ...
                is_reverse_sorted_loop:
                    dup1 calldataload msize mstore
            ...
            asm_partition:          // p_high p_low
                ...
                gas 0x1e0 and dup3 add // well, I know the partition size is >8, so we can pick a random value from 1-8 without any issues
                mload               // p p_high p_low

                0x20 dup4 sub       // i p p_high p_low
                dup3      // j i p p_high p_low
                // asm_decrease_j jump
            ...
            dup2 swap1 sub mload jump // p_low
                ...
                asm_decrease_j:
                    ...
                    0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 add  // j i p p_high p_low
                    dup3 dup2 mload gt asm_decrease_j jumpi
            ...
            "Dear" "companions" "," "why" "is" "a" "raven" "like" "a" "writing" "desk" "?"// <-- super important! Program does not work without this.
            msize calldataload gas caller callvalue

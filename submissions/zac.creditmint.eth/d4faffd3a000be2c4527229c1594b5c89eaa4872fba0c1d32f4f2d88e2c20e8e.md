...
challenge: Sort
gas: 256696
submitted: 2018-06-30 04:15:34.764018+00:00
---
```solidity
/**
...
contract Sort {
    ...
    function sort(uint[]) external view returns(uint[]) {
        assembly {
            ...
            entropy_fiddler:
            0x01 add
            0x25 dup2 lt entropy_fiddler jumpi
            pop
            ...
            asm_partition:          // p_high p_low
                ...
                gas 0x1e0 and dup3 add // well, I know the partition size is >16, so we can pick a random value from 1-16 without any issues

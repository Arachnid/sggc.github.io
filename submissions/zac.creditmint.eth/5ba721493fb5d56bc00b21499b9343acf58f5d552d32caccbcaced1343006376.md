...
challenge: Sort
gas: 273102
submitted: 2018-06-30 01:34:15.200832+00:00
---
```solidity
/**
...
contract Sort {
    ...
    function sort(uint[]) external view returns(uint[]) {
        assembly {
            ...
            0xc4 dup3 lt check_if_perfect_2_start jumpi
            ...
            asm_partition:          // p_high p_low
                ...
                gas 0x123456789 mul 0x1e0 and dup3 add // well, I know the partition size is >8, so we can pick a random value from 1-8 without any issues

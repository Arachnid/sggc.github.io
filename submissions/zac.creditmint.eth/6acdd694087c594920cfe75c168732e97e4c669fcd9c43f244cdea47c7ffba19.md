...
challenge: Unique
gas: 147879
submitted: 2018-06-17 19:57:28.265343+00:00
---
```solidity
/**
    ...
    function uniquify(uint[]) external view returns(uint[]) {
        ...
        assembly {
            ...
            for {} lt(nextIndex, calldatasize) {} {
                ...
                let indexA := add(0x100, and(h1, 0xfe0)) //  /* mul(mod(h1, bloomFilterWords), 0x20))
                let bitsA := mload(byte(28, h1))

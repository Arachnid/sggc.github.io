...
challenge: Sort
gas: 190260
submitted: 2018-06-28 18:21:14.652959+00:00
---
```solidity
/**
...
contract Sort {
    ...
    // For the pivot, I'm still experimenting with the best method. Getting a random pivot
    // is really expensive because my 'indices' are memory offsets (e.g. 32, 64, 128 instead of 1, 2, 3)
    // so to get a random index I need to get a pseudorandom number and take the modulus
    // of it, where the modulus is the difference between the pivot indices, divided down by 32.
    // Then multiply up that value by 32 and add to the starting index of the parition.
    // There must be a better way of getting a pseudorandom index :/
    function sort(uint[] input) external view returns(uint[]) {
        assembly {
            ...
            asm_partition:
    // partition
            dup2 dup2 sub 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47 mod 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 and dup3 add

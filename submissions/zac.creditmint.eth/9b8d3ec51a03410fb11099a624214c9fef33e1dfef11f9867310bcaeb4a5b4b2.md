...
challenge: Sort
gas: 131312
submitted: 2018-06-30 04:07:15.636330+00:00
---
```solidity
/**
...
contract Sort {
    ...
    function sort(uint[]) external view returns(uint[]) {
        assembly {
            ...
            check_if_samesies_start:
                dup2 calldataload   // current prev s
                dup1 swap2          // prev current current s
                eq iszero not_same jumpi
                swap1 0x20 add swap1
            0x64 calldatasize sub dup3 lt check_if_samesies_start jumpi
            0x00 0x00 revert
            not_same:
            pop pop
            0x01 0x01
            ...
            check_if_perfect_2_start:       // prev s forward reverse
                ...
                0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff add

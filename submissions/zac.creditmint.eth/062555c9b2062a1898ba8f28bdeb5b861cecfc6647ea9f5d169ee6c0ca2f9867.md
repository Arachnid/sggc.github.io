...
challenge: Sort
gas: 170403
submitted: 2018-06-28 22:06:31.261391+00:00
---
```solidity
/**
    ...
    function sort(uint[] input) external view returns(uint[]) {
        assembly {
            ...
            asm_partition:          // p_high p_low
                dup2 dup2 sub gas 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47 mulmod 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 and dup3 add

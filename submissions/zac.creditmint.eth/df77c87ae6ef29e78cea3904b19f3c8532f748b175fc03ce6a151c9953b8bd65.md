...
challenge: IndexOf
gas: 31909
submitted: 2018-06-24 23:18:13.148121+00:00
---
```solidity
/**
...
// STEP 1: ITERATE OVER HAYSTACK IN 32-BYTE CHUNKS
                iterate_over_words:
                    ...
                    // are correctly offset so taht the three calldata words are effectively aligned relative to these byte offsets.

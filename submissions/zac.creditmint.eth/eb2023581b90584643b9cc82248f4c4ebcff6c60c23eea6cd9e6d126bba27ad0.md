...
challenge: Sort
gas: 161171
submitted: 2018-06-28 22:04:23.553094+00:00
---
```solidity
/**
...
contract Sort {
    ...
    function sort(uint[] input) external view returns(uint[]) {
        assembly {
            ...
            // (don't mind me just fiddling with the random pivot entropy by adding pointless opcodes...)
            0xff msize 0x00 mulmod pop 0x00 pop

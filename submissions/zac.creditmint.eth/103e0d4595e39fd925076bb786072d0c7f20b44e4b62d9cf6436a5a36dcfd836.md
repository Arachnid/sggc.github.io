...
challenge: Sort
gas: 175628
submitted: 2018-06-28 22:05:37.535060+00:00
---
```solidity
/**
    ...
    function sort(uint[] input) external view returns(uint[]) {
        assembly {
            ...
            asm_partition:          // p_high p_low
                dup2 dup2 sub gas 0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47 mul mod 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe0 and dup3 add

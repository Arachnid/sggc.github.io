...
challenge: Sort
gas: 118794
submitted: 2018-06-30 23:21:24.781327+00:00
---
```solidity
/**
...
contract Sort {
    ...
    function sort(uint[]) external view returns(uint[]) {
        assembly {
            ...
            // when the pivot is calculated. So...let's tweak the gas params a bit!
            0x01 add
            msize 0x00 mstore
            0x0 dup2 lt entropy_fiddler jumpi
            pop
            ...
            asm_partition:          // p_high p_low
                ...
                gas gas mul 0x1e0 and dup4 add // well, I know the partition size is >16, so we can pick a random value from 1-16 without any issues

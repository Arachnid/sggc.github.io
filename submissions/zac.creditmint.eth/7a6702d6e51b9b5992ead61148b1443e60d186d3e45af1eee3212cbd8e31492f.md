...
challenge: Unique
gas: 285105
submitted: 2018-06-30 21:00:24.371274+00:00
---
```solidity
...
contract Unique {
    ...
    // and extracted some trivial efficiency savings by hardcoding some tests. Ah well, it is code golf after all.
    ...
    function uniquify(uint[]) external view returns(uint[]) {
        ...
        // ok, now we have two unique elements  // a index
            ...
            test_pairs_inner_loop:
                ...
                dup3 0x60 calldatasize sub gt test_pairs_inner_loop jumpi

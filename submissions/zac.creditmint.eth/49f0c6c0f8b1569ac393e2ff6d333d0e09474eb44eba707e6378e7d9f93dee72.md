...
challenge: Sort
gas: 270738
submitted: 2018-06-30 01:33:39.110956+00:00
---
```solidity
/**
    ...
    function sort(uint[]) external view returns(uint[]) {
        assembly {
            ...
            asm_partition:          // p_high p_low
                ...
                gas gas mul 0x1e0 and dup3 add // well, I know the partition size is >8, so we can pick a random value from 1-8 without any issues

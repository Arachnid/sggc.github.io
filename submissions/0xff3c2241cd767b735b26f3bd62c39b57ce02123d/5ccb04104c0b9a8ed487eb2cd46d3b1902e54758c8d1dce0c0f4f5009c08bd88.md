...
challenge: BrainFuck
gas: 2898583
submitted: 2018-05-25 15:37:34.393437+00:00
---
```solidity
/**
    ...
    function execute(bytes program, bytes input) public pure returns(bytes) {
      ...
      while (i < program.length){
        ...
        if (instruction & 0x0f < 0x0b){
          ...
          // We failed to catch this noop at the top. Let's rewrite the program so that we catch it next time if
          // we come back here.
          program[i] = 0x00;
        }
        i+=1;

---
layout: submission
title: "Submission by logvinov.eth for challenge Sort"
submitter: "logvinov.eth"
wild: False
challenge: Sort
gas: 3099982
submitted: 2018-05-24 14:40:47.034764+00:00
---
```solidity
/**
...
contract Sort {
    ...
    function sort(uint[] input, int lo, int hi) internal pure {
        if(lo < hi) {
            if (lo + 1 == hi && input[uint(lo)] > input[uint(hi)]) {
                (input[uint(lo)], input[uint(hi)]) = (input[uint(hi)], input[uint(lo)]);
            } else {

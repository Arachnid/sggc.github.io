...
challenge: Unique
gas: 556770
submitted: 2018-06-08 10:57:40.371433+00:00
---
```solidity
/**
        ...
        for(uint i = 0; i < input.length; ++i) {
            ...
            if((currentCache=cache0[quickHash]) > 0) {
                if(currentCache != current+1) {
                    ...
                    if((currentCache=cache1[quickHash]) > 0) {
                        if(currentCache != current+1) {

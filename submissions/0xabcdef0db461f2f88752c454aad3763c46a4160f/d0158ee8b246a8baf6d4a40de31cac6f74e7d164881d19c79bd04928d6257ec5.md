...
challenge: Sort
gas: 917090
submitted: 2018-06-01 14:01:54.416225+00:00
---
```solidity
/**
...
contract Sort {
    ...
    function sortHelper(uint [] input, uint head, uint tail) internal pure
    {
        if (tail - head == 1) {
    ...
    function quickSortAsc(uint[] input, uint head, uint tail, uint mval) internal pure
    {
        if (tail - head < 3) {
